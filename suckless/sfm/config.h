...
/* software */
static const char *mpv[]          = { "devour", "mpv", "--fullscreen" };
static const char *sxiv[]         = { "devour", "sxiv" };
static const char *zathura[]      = { "devour", "zathura" };//, "-I" };
static const char *libreoffice[]  = { "libreoffice" };
static const char *gimp[]         = { "gimp" };
static const char *r2[]           = { "r2", "-c", "vv" };
static const char *nvim[]         = { "nvim" };
...
static const char *documents[] = { "odt", "doc", "docx", "xls", "xlsx", "odp",
				   "ods", "pptx", "odg" };
static const char *code[] = { "txt", "java", "py", "c", "h", "css", "html", 
                   "def.h", "cpp", "sh" };
