...
Config.instname = "Hochschule Heilbronn"
Config.profilename = "Hochschule Heilbronn"
Config.url = "https://www.hs-heilbronn.de/rz/netzzugang"
Config.email = "ticket@hs-heilbronn.de"
Config.title = "eduroam CAT"
Config.server_match = "hhn.hs-heilbronn.de"
...
Config.user_realm = "hs-heilbronn.de"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:radius.hhn.hs-heilbronn.de', 'DNS:radius2.hhn.hs-heilbronn.de']
Config.use_other_tls_id = False
Config.anonymous_identity = "anonymous@hs-heilbronn.de"
