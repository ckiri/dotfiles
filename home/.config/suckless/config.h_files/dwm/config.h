...
static const char *brightdn[] = { "backlight_control", "-20", NULL };
static const char *brightup[] = { "backlight_control", "+20", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_BackSpace, killclient,  {0} },           // Modifiziert, zuvor XK_c
