...
dunst 2>&1 &
kanshi >/dev/null 2>&1 &
test -d /sys/class/power_supply/BAT1 && $HOME/.local/bin/battery.sh 2>&1 &
gammastep -l 49.0:9.2 -t 5700:3600 >/dev/null 2>&1 &
dconf write /org/gnome/desktop/interface/color-scheme '"prefer-light"' 2>&1 &
gsettings set org.gnome.desktop.interface gtk-theme 'Adwaita' 2>&1 &
gsettings set org.gnome.desktop.interface icon-theme 'Papirus' 2>&1 &
swayidle -w \
